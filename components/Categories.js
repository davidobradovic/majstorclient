      ...
      <View style={[ tw`px-3` ]}>
         ...
         <View style={[tw`flex flex-row flex-wrap rounded-2xl border border-gray-200 overflow-hidden bg-white shadow-sm`]}>
           {categories.map((category) => (
             <TouchableOpacity 
               key={category.id} 
               style={[tw`w-1/4 flex items-center justify-center gap-2 border border-gray-100 py-4`]}
               onPress={() => handleCategorySelect(category)}
             >
               <Image style={[tw`h-12 w-12`]} source={{ uri: `https://backend.davidtesla.online/uploads/${category.icon}` }} />
                ...
                <View style={[tw`px-6 pt-8 pb-4 flex flex-row justify-between items-center border-b border-gray-100`]}>
                  <View style={tw`flex-row items-center`}>
                    <View style={[
                      ...
                      <Image style={[tw`h-6 w-6`]}  source={{ uri: `https://backend.davidtesla.online/uploads/${selectedCategory.icon}` }}  />
                    </View>
          ...
          <View style={tw`px-4 pt-4 pb-2 flex-row items-center justify-between border-b border-gray-100`}>
            ...
            <View style={tw`flex-row items-center`}>
              <View style={[
                ...
                {selectedCategory && <Image style={[tw`h-4 w-4`]}  source={{ uri: `https://backend.davidtesla.online/uploads/${selectedCategory.icon}` }}  />}
              </View>
              <View>
